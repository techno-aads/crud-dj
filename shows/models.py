...
class ShowForm(ModelForm):
    ...
    running_time = forms.CharField(widget=forms.NumberInput(attrs={'class': 'form-control', 'placeholder': "107"}))
    ...
    run_date = forms.DateTimeField(widget=forms.DateTimeInput(attrs={'class': 'form-control', 'placeholder':"2016-12-10 16:00:00"}))
    #has_ads = forms.BooleanField(widget=forms.CheckboxInput(attrs={'class': 'checkbox'}))
